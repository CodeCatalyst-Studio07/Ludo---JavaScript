...
export const STEP_LENGTH = 10 / 1.5;

const PLAYERS_LENGTH = parseInt(
  prompt("How many players are you want to play? (2/4): ", 2)
);

export const PLAYERS =
  PLAYERS_LENGTH === 4 ? ["blue", "green", "yellow", "red"] : ["blue", "green"];

export const BASE_POSITIONS = {
  blue: [500, 501, 502, 503],
  green: [600, 601, 602, 603],
  yellow: [700, 701, 702, 703],
  red: [800, 801, 802, 803],
};
